...
public class RotationalLightsBackup {
    private static final BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
    public static void main(String[] args) throws IOException {
        int n = readInt();
        int t = readInt();
        ArrayList<Integer[]> validLightsOn = new ArrayList<>();
        Integer[] currentLightsOn = new Integer[n];
    ...
    private static void removeDupes(int r, int t, ArrayList<String> l) {
        for(int i = 1; i <= t / r; i++) {
            l.remove(Integer.toString(r * i));
        }
    }
